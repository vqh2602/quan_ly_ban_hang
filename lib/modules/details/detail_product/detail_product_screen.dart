...
class _DetailProductState extends State<DetailProductSreen> {
  ...
  Widget build(BuildContext context) {
    return detailProductController.obx((state) => buildBody(
          context: context,
              ...
              children: [
                        ...
                        onTap: () async {
                          if (isView) {
                            Get.to(ViewImageWithZoom(
                                url: detailProductController.product?.image ??
                                    'Trống',
                                index: -1));
                          } else {
                            // Pick an image.
                              ...
                              child: imageNetwork(
                                  url: isView
                                      ? detailProductController
                                              .product?.image ??
                                          'Trống'
                                      : detailProductController.imageUrl ??
                                          'Trống',
                                  fit: BoxFit.cover),
                            )),
                      ),
                ...
                boxDetail(
                  ...
                  children: [
                    ...
                    titleEditTitle(
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          showBottomTextInput(detailProductController.codeTE,
                              onCancel: () {
                    ...
                    titleEditTitle(
                      ...
                      showEdit: isIconEdit,
                      value: isView
                          ? detailProductController.product?.name ?? 'Trống'
                          : detailProductController.nameTE?.text ?? 'Trống',
                      onTap: () {
                        Get.bottomSheet(
                          showBottomTextInput(detailProductController.nameTE,
                              onCancel: () {
                    ...
                    titleEditTitle(
                      ...
                      showEdit: isIconEdit,
                      value: isView
                          ? detailProductController.product?.bardcode ?? 'Trống'
                          : detailProductController.barcodeTE?.text ?? 'Trống',
                      onTap: () {
                        Get.bottomSheet(
                          showBottomTextInput(detailProductController.barcodeTE,
                              onCancel: () {
                    ...
                    titleEditTitle(
                      ...
                      value: ShareFuntion.formatCurrency(isView
                          ...
                          : num.parse(
                              detailProductController.priceTE?.text ?? '0')),
                      onTap: () {
                        Get.bottomSheet(
                          showBottomTextInput(detailProductController.priceTE,
                              keyboardType: TextInputType.number, onCancel: () {
                    ...
                    titleEditTitle(
                        title: 'Giá nhập',
                        value: ShareFuntion.formatCurrency(isView
                            ? detailProductController.product?.importPrice ?? 0
                            : num.parse(
                                detailProductController.importPriceTE?.text ??
                                    '0')),
                        onTap: () {
                          Get.bottomSheet(
                            showBottomTextInput(
                                ...
                                onCancel: () {
                              detailProductController.importPriceTE?.text =
                                  detailProductController.product?.importPrice
                                          .toString() ??
                                      '0';
                            }, onSubmitted: () {
                              detailProductController.updateUI();
                    ...
                    titleEditTitle(
                        ...
                        value: isView
                            ? ShareFuntion.getUnitWithIDFunc(
                                        detailProductController.product?.unit,
                                        listUnit: detailProductController
                                            .listUnit
                    ...
                    titleEditTitle(
                      ...
                      value: isView
                          ? detailProductController.product?.quantity
                                  .toString() ??
                              '0'
                          : detailProductController.quantityTE?.text ?? '0',
                      onTap: () {
                        Get.bottomSheet(
                          showBottomTextInput(
                        ...
                        Get.bottomSheet(
                          showBottomTextInput(
                            ...
                            detailProductController.discountTE?.text =
                                detailProductController.product?.discount
                                        .toString() ??
                                    '0';
                          }, onSubmitted: () {
                            detailProductController.updateUI();
                ...
                boxDetail(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        for (var category
                            in detailProductController.listCategorySelect ??
                                []) ...[
                          Chip(
                            ...
                            avatar: Icon(
                              ...
                              color: Color(
                                  int.parse('0xff${category.data.color}')),
                            ),
                ...
                boxDetail(
                  ...
                  children: [
                    ...
                    ExpandableText(
                      isView
                          ? detailProductController.product?.note ?? 'Trống'
                          : detailProductController.noteTE?.text ?? 'Trống',
                      expandText: 'xem thêm',
